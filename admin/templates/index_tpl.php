...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Devetloper by : <a href="http://CIPMEDIA.vn">CIPMEDIA .LTD</a>'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by <a href="http://www.CIPMEDIA.vn" target="_blank"><span style="color:#f00;">Thiết kế website CIPMEDIA</span></a></h6><div class="clear"></div></div>
   <p>Nếu bạn có thắc mắc trong quá trình sử dụng, xin vui lòng gởi mail về địa chỉ <strong><a href="mailto:CIPMEDIA@CIPMEDIA.vn">CIPMEDIA@CIPMEDIA.vn</a></strong></p>
