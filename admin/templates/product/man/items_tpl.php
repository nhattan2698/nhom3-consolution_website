<style>
  .main_select{max-width: 105px !important;}
</style>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <!-- <td class="tb_data_small">Sales</td> -->
        <!-- <td class="tb_data_small">Còn hàng</td> -->
...
<?php /*?>                        <td align="center">
                          <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['conhang']?>" data-val3="conhang" class="diamondToggle <?=($items[$i]['conhang']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a>   
                        </td>   <?php */?>
                        <td align="center">
