...
function save_photo(){
	...
	if($id){
		...
		if($photo = upload_image("photo_vi", 'Jpg|jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name)){
			$data['photo_vi'] = $photo;
		...
		if($photo = upload_image("photo_en", 'Jpg|jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name.'_en')){
			$data['photo_en'] = $photo;
			$data['thumb_en'] = create_thumb($data['photo_en'], _width_thumb, _height_thumb , _upload_hinhanh,$file_name.'_en',_style_thumb);	
			$d->setTable('photo');
			$d->setWhere('id', $id);
			$d->select();
			if($d->num_rows()>0){
		...
		if($photo = upload_image("photo_cn", 'Jpg|jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name.'_cn')){
			$data['photo_cn'] = $photo;
			$data['thumb_cn'] = create_thumb($data['photo_cn'], _width_thumb, _height_thumb , _upload_hinhanh,$file_name.'_cn',_style_thumb);	
			$d->setTable('photo');
			$d->setWhere('id', $id);
			$d->select();
			if($d->num_rows()>0){
...
function save_multiphoto(){
	...
	for($i=0; $i<5; $i++){
		...
		{		
			$data['thumb_vi'] = create_thumb($data['photo_vi'], _width_thumb, _height_thumb , _upload_hinhanh,$file_name.$i,_style_thumb);										
			$data['stt'] = $_POST['stt'.$i];
			$data['ten_vi'] = $_POST['ten_vi'.$i];	
			$data['ten_en'] = $_POST['ten_en'.$i];	
			$data['ten_cn'] = $_POST['ten_cn'.$i];	
