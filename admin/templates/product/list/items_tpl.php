...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=product&act=man_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span><?=  $title_main ?></span></a></li>
        	<?php if($_GET['keyword']!=''){ ?>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <?php if ($config_index=='true'): ?>
        <td class="tb_data_small">Trang chủ</td>
        <?php endif ?>
        <!-- <td class="tb_data_small">BỘ LỌC</td> -->
...
<?php /*?>          <td align="center">
          <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['menu']?>" data-val3="menu" class="diamondToggle <?=($items[$i]['menu']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a>   
        </td> <?php */?>
        <?php if ($config_index=='true'): ?>
        <td align="center">
        ...
        <?php endif ?>
<?php /*?>          <td align="center">
          <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['isfilter']?>" data-val3="isfilter" class="diamondToggle <?=($items[$i]['isfilter']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a>   
        </td> <?php */?>
         <td align="center">
