		...
		<?php if($config_album=='true'){ ?>
			<div class="formRow">
				...
				<div class="formRight">
					...
					<div class="note"> width: <?=  _width_thumb ?>px , Height: <?=  _height_thumb ?>px </div>
					<div class="clear"></div>
					<?php if($act=='capnhat'){ ?>
...
<?php /*?> 		<div class="formRow lang_hidden lang_vi active">
			...
			<div class="formRight">
				<input type="text" name="ten2_vi" title="Nhập tên danh mục" id="ten2_vi" class="tipS validate[required]" value="<?=@$item['ten2_vi']?>" />
			</div>
			<div class="clear"></div>
		</div> <?php */?>
		...
		<div class="formRow lang_hidden lang_vi active">
			<label>Mô tả</label>
			<div class="formRight">
				<textarea rows="15" cols="" title="Nhập mô tả . " class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow lang_hidden lang_en">
			...
			<div class="formRight">
				<textarea rows="15" cols="" title="Nhập mô tả . " class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
		<?php
		if($config_noidung=='true'){ ?>
		<div class="formRow lang_hidden lang_vi active">
