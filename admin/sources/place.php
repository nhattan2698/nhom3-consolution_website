	...
	#====================================
	function get_citys(){
		global $d, $items, $url_link,$totalRows , $pageSize, $offset,$page,$paging;
		if(!empty($_POST)){
		...
		#----------------------------------------------------------------------------------------
		if($_SESSION['phantrang']){
		$per_page = $_SESSION['phantrang']; // Set how many records do you want to display per page.
	} else {
	...
	if($_REQUEST['keyword']!='')
	{
		...
		// $sql= "SELECT count(id) AS numrows FROM table_place_city $where";
		// $d->query($sql);	
		// $dem=$d->fetch_array();
...
function get_city(){
	...
	$sql = "select * from table_place_city where id='".$id."'";
	$d->query($sql);
...
if(isset($_GET['id'])){
	$id =  themdau($_GET['id']);
	$d->reset();		
	$sql = "delete from table_place_city where id='".$id."'";
	if($d->query($sql))
...
function get_dists(){
	...
	$sql= "SELECT count(id) AS numrows FROM table_place_dist $where";
	$d->query($sql);	
	$dem=$d->fetch_array();

	if($_REQUEST['id']!='')
	{		
		$where .=" where id_city = ".$_GET['id'];
		$link_add .= "&id_city=".$_GET['id'];
	}

	$where .=" order by id_city asc";
	$sql = "select * from $where $limit";
	$d->query($sql);
	$items = $d->result_array();
...
function get_dist(){
	...
	$sql = "select * from table_place_dist where id='".$id."'";
	$d->query($sql);
...
if(isset($_GET['id'])){
	$id =  themdau($_GET['id']);
	$d->reset();		
	$sql = "delete from table_place_dist where id='".$id."'";
	if($d->query($sql))
...
function get_wards(){
	...
	$sql= "SELECT count(id) AS numrows FROM table_place_ward $where";
	$d->query($sql);	
	$dem=$d->fetch_array();
	$totalRows=$dem['numrows'];
	$page=$_GET['p'];
	...
	$page--;
	$bg=$pageSize*$page;		
	$sql = "SELECT * from table_place_ward $where order by id limit $bg,$pageSize";		
	$d->query($sql);
	$items = $d->result_array();	
...
function get_ward(){
	...
	$sql = "select * from table_place_ward where id='".$id."'";
	$d->query($sql);
...
if(isset($_GET['id'])){
	$id =  themdau($_GET['id']);
	$d->reset();		
	$sql = "delete from table_place_ward where id='".$id."'";
	if($d->query($sql))
...
function get_streets(){
	...
	$sql= "SELECT count(id) AS numrows FROM table_place_street $where";
	$d->query($sql);	
	$dem=$d->fetch_array();
	$totalRows=$dem['numrows'];
	$page=$_GET['p'];
	...
	$page--;
	$bg=$pageSize*$page;		
	$sql = "SELECT * from table_place_street $where order by id limit $bg,$pageSize";		
	$d->query($sql);
	$items = $d->result_array();	
...
function get_street(){
	...
	$sql = "select * from table_place_street where id='".$id."'";
	$d->query($sql);
...
if(isset($_GET['id'])){
	$id =  themdau($_GET['id']);
	$d->reset();		
	$sql = "delete from table_place_street where id='".$id."'";
	if($d->query($sql))
