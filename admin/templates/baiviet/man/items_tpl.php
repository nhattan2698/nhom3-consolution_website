...
<div class="control_frm" style="margin-top:0;">
    <div style="float:left;">
      <input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=baiviet&act=add<?php if($_REQUEST['id_list']!='') echo'&id_list='. $_REQUEST['id_list'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'" />
    ...
    <thead>
      <tr>
        ...
        <?php if($config_noibat=='true'){ ?> 
         ...
         <?php } ?>
        <?php if($config_dangthuchien=='true'){ ?> 
         <td class="tb_data_small">ĐANG / ĐÃ THỰC HIỆN</td>  
         <?php } ?>
    ...
    <tbody>
       ...
       <td>
        ...
        <td class="title_name_data">
            <a href="index.php?com=baiviet&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id_sub=<?=$items[$i]['id_sub']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" class="tipS SC_bold"><?=$items[$i]['ten_vi']?> <?=$items[$i]['more_vi']?></a>
        </td>
<?php if($config_noibat=='true'){ ?> 
        <td align="center">
